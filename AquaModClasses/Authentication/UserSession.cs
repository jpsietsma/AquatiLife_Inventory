...
namespace AquaModClasses.Authentication
{
    ...
    public class UserSession
    {
        ...
        /// <summary>
        /// Get Timespan representing the length of the user login session
        /// </summary>
        /// <returns>
        /// timespan object representing the length of the user login session, null if session is still active
        /// </returns>
        public TimeSpan? GetSessionTimespan()
        {
            if (SessionEnd.HasValue)
            {
                return SessionBegin - SessionEnd;
            }
            else
            {
                return null;
