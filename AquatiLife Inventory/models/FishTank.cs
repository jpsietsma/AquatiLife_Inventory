...
namespace AquatiLife_Inventory.models
{
    ...
    public class FishTank : TankAccessory
    {
        ...
        public FishTank(string tankDescription, double tankCost, DateTime purchaseDate, Locations purchaseLocation, double tankSize = 0.00) : base(tankDescription, tankCost, purchaseDate, purchaseLocation)
        {
